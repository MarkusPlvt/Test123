...
import prog.ex11.solution.saveandload.factory.BinaryPersistenceFactory;
...
public class TestBinaryPersistenceFactoryGoodCases {
  private static final org.slf4j.Logger logger =
          org.slf4j.LoggerFactory.getLogger(TestBinaryPersistenceFactoryGoodCases.class);
  ...
  public void setup() throws TooManyToppingsException {
    factory = new BinaryPersistenceFactory();
